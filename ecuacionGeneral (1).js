...
function clasificarCuadrica() {
    // Obtener valores de coeficientes desde los campos de entrada
    ...
    const coefD = parseFloat(document.getElementById('coefD').value);
    const coefE = parseFloat(document.getElementById('coefE').value);
    ...
    const resultado = ecuacionGeneral(coefA, coefB, coefC, coefD, coefE, coefF, coefG);

    // Mostrar resultado en el elemento resultado
